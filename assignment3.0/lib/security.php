...
function securityCheck($path_parts, $yourURL, $form = false) {
   ...
   $whiteListPages[] = "q05.php";
    ...
    $whiteListFolders[] = "/cs148/assignment3.0/q01.php";
    $whiteListFolders[] = "/cs148/assignment3.0/select.php";
    $whiteListFolders[] = "/cs148develop/assignment3.0/query1.php";
    $whiteListFolders[] = "/cs148develop/assignment3.0/query2.php";
    $whiteListFolders[] = "/cs148develop/assignment3.0/index.php";
