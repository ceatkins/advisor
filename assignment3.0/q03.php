...
print '<table>';
$query = 'select distinct fldCourseName, fldDays, fldStart from tblSections, tblCourses where tblSections.fnkTeacherNetId = "jlhorton" and tblSections.fnkCourseId = tblCourses.pmkCourseId;';
