...
print '<table>';
$query = 'SELECT DISTINCT fldDays, fldStart FROM tblSections, tblTeachers WHERE tblTeachers.fldLastName = "Snapp" AND tblTeachers.pmkNetID = tblSections.fnkTeacherNetId ORDER BY fldStart';
